...
Namespace SplitAppointment
	Partial Public Class MainForm
		...
		Private Sub SchedulerControlPreparePopupMenu(ByVal sender As Object, ByVal e As DevExpress.XtraScheduler.PreparePopupMenuEventArgs) Handles schedulerControl.PreparePopupMenu
		...
		Private Sub barBtnGroupByNone_ItemClick(ByVal sender As Object, ByVal e As DevExpress.XtraBars.ItemClickEventArgs) Handles barBtnGroupByNone.ItemClick
			schedulerControl.GroupType = SchedulerGroupType.None
		End Sub
		#End Region
		#Region "barBtnGroupByDate_ItemClick"
		Private Sub barBtnGroupByDate_ItemClick(ByVal sender As Object, ByVal e As DevExpress.XtraBars.ItemClickEventArgs) Handles barBtnGroupByDate.ItemClick
			schedulerControl.GroupType = SchedulerGroupType.Date
		End Sub
		#End Region
		#Region "barBtnGroupByResource_ItemClick"
		Private Sub barBtnGroupByResource_ItemClick(ByVal sender As Object, ByVal e As DevExpress.XtraBars.ItemClickEventArgs) Handles barBtnGroupByResource.ItemClick
		...
		Private Sub OnAppointmentCollectionChanged(ByVal sender As Object, ByVal e As PersistentObjectsEventArgs) Handles schedulerStorage.AppointmentsChanged, schedulerStorage.AppointmentsInserted
